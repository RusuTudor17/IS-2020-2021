...
public class Constants {
    ...
    public static class Tables {
        ...
        public static final String CLIENT_CONT="client_cont";

        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE, CLIENT,CONT};
    }
